...
2. **State Management:**
   ...
   - Use `stop_server(server_name)` only after you believe all work required from a server is finished.
...
- **execute_server_code**: Use this to perform the actual work (writing code) once a server is active.
